...
function Blogs ()
 {
  ...
  const handleChange = name => event => {
    ...
    return (
      <BaseLayout>
        <div className="mb-5 " style={{ marginTop: "80px",marginLeft:'15px',marginRight:'15px' }}>
          <div className="row">
            <h4 className="TitleCountry text-white font-weight-bold">
            <div className="mt-5 font-weight-bold">All Property</div> 
            </h4>
          </div>
                      ...
                      <div className="row w-100">
                        ...
                        <div className="col-md-12 mb-5">
                          <div className="input-group">
                            <div className="input-group-prepend w-25" style={{marginRight:'40px'}}>
                              <label
                                className="input-group-text" 
                        ...
                        <div className="col-md-12 mb-5">
                        <div className="input-group">
                          <div className="input-group-prepend w-25" style={{marginRight:'30px'}}>
                            <label
                              className="input-group-text" 
                              htmlFor="inputGroupSelectDistance" style={{paddingRight:'40px'}}
                            >
                             Bathrooms:  
                            </label>
                          </div>
                       ...
                       <span  style={{marginRight:"100px"}}> Min price:${value[0]}</span><span>Max price:${value[1]}</span>
                       </Typography>
            ...
            <div className="row mb-4 ml-3">
              ...
              <Link href="/propertyDetails">
                <div className="card booking-card">
                  <div className="view overlay view-cascade">
                    <img
