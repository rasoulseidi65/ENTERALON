  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <div className="d-flex TopheaderRight header transparent scroll-hide">
          ...
          <div className="ml-auto">
            <button className="btn btn-outline-danger btn-rounded1 waves-effect">
              Login
            </button>
            <button className="btn btn-outline-danger btn-rounded1 waves-effect">
              Register
            ...
            >
              <ul className="navbar-nav mt-4  pb-2">
                <li className="nav-item dropdown mega-dropdown mr-2 text-white">
                  ...
                  <div
                    className="dropdown-menu mega-menu  py-5 px-3"
                    ...
                    <div className="row animated zoomIn delay-05s">
                      <div className="col-md-6 col-xl-3 sub-menu mb-xl-0 mb-4">
                        <h6 className="sub-title text-uppercase font-weight-bold white-text">
                          Properties For Sales The Countries
                        </h6>
                        <Divider className="white" />
                        <ul className="list-unstyled mt-2">
                          <li className="mb-3 ml-3">
                            <a className="menu-item pl-0">
                              <i className="fa fa-caret-right pl-1 pr-3"></i>UK
                              property for sale
                            </a>
                          </li>
                          <li className="mb-3 ml-3">
                            <a className="menu-item pl-0">
                              <i className="fa fa-caret-right pl-1 pr-3"></i>
                      ...
                      <div className="col-md-6 col-xl-3 sub-menu mb-xl-0 mb-4">
                        ...
                        <ul className="list-unstyled mt-2">
                          <li className="mb-3 ml-3">
                            <a className="menu-item pl-0">
                              <i className="fa fa-caret-right pl-1 pr-3"></i> The
                              UK
                            </a>
                          </li>
                          <li className="mb-3 ml-3">
      ...
      >
        ...
        <List>
          <ListItem
            className="mdb-color darken-3  text-white"
            key="menuHeading"
            disableGutters
          >
            <ListItemText inset primary="Main Menu" />
          </ListItem>
          {handler(Menu)}
        </List>
        <Divider />
        ...
        <div className="ml-1 mt-3">
          <button className="btn btn-outline-danger btn-rounded text-white Login ">
            Login
          </button>
          <button className="btn btn-outline-danger btn-rounded text-white ">
            Sign Up
          </button>
        </div>
      </Drawer>
