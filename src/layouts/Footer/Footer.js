        ...
        return (
            <div>
                ...
                <footer className="page-footer  mt-2 font-small grey lighten-4">
                    ...
                    <div className="body-footer text-center text-md-left  pl-4">
                        ...
                        <div className="row mt-3 text-white">
                            ...
                            <div className="col-md-3 col-lg-4 col-xl-3 mb-4">
                                ...
                                <h6 className="text-uppercase font-weight-bold pt-3">Company name</h6>
                            ...
                            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                                ...
                                <h6 className="text-uppercase font-weight-bold pt-3">Products</h6>
                                <hr className="teal accent-3 mb-4 mt-0 d-inline-block mx-auto"/>
                                    <p>
